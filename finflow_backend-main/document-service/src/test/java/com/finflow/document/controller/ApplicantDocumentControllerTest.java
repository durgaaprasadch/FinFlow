...
class ApplicantDocumentControllerTest {
    ...
    @MockBean
    private com.finflow.document.client.ApplicationServiceClient applicationServiceClient;
    ...
    void uploadAllDocuments_ShouldReturnBulkUploadResponse() throws Exception {
        ...
        when(applicationServiceClient.getActiveApplicationId("durga@gmail.com", "APPLICANT", "applicant-1"))
                .thenReturn(1L);
        ...
        mockMvc.perform(multipart("/api/documents/upload-all")
                        .file(aadhaar)
                        .file(pan)
                        .file(salary)
                        .file(bank)
    ...
    void getDocumentsZip_ShouldReturnZipFile() throws Exception {
        ...
        mockMvc.perform(get("/api/documents")
                ...
                .andExpect(result -> {
                    ...
                    assert contentType != null && contentType.contains("application/octet-stream");
                });
    }
