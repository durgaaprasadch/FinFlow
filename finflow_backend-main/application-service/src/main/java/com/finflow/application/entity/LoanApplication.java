...
public class LoanApplication implements Serializable {
    ...
    @Column(length = 500)
    private String reuploadModules; // Comma-separated types e.g. "AADHAAR,PAN"
    ...
    public String getReuploadModules() { return reuploadModules; }
    public void setReuploadModules(String reuploadModules) { this.reuploadModules = reuploadModules; }
