...
class AuthenticationFilterTest {
    ...
    void apply_ShouldBypassPublicEndpoints() {
        ...
        void apply_ShouldReturnUnauthorized_WhenMissingHeader() {
                MockServerHttpRequest request = MockServerHttpRequest.get("/api/applications").build();
                MockServerWebExchange exchange = MockServerWebExchange.from(request);
        ...
        void apply_ShouldReturnUnauthorized_WhenTokenIsInvalid() {
                MockServerHttpRequest request = MockServerHttpRequest.get("/api/applications")
        ...
        void apply_ShouldReturnForbidden_WhenApplicantTriesToAccessAdminRoute() {
                MockServerHttpRequest request = MockServerHttpRequest.get("/api/admin/system")
    ...
    void apply_ShouldBypassOptionsRequest() {
        when(chain.filter(any())).thenReturn(Mono.empty());
        MockServerHttpRequest request = MockServerHttpRequest.options("/api/applications").build();
        MockServerWebExchange exchange = MockServerWebExchange.from(request);
    ...
    void apply_ShouldAllowAccess_ForPublicEndpoints() {
        String[] publicPaths = {
            ...
            "/api/auth/v3/api-docs", "/api/admin/v3/api-docs", "/swagger-ui/index.html",
