...
public class ApplicantDocumentController {
    ...
    public ApiResponse<Map<String, Object>> uploadAllDocuments(
            ...
            @RequestPart(value = "salarySlipFile", required = false) MultipartFile salarySlipFile,
            @RequestPart(value = "bankStatementFile", required = false) MultipartFile bankStatementFile,
