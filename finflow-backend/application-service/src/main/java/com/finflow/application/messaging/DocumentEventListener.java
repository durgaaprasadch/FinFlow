...
public class DocumentEventListener {
    ...
    public void handleDocumentUploaded(DocumentMessage message) {
        ...
        try {
            ...
            log.info("Processing document upload event: {} for Application ID: {} (Type: {})", eventId, applicationId, message.getDocumentType());
            
            applicationService.syncStatusAfterDocumentUpload(applicationId, message.getDocumentType());
