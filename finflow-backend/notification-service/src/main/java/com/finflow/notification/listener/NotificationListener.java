...
public class NotificationListener {
    ...
    public void handleRegistrationNotification(NotificationRequest request) {
        ...
        inAppStore.add(request.getTo(), InAppNotification.create(
                request.getTo(),
                "Welcome to FinFlow 🎉",
                "Your account has been created successfully" + (name != null ? ", " + name : "")
    ...
    private String buildLoanStatusMessage(String status, String amount) {
        ...
        return switch (upper) {
            ...
            case "SUBMITTED" ->
                "Final Protocol: Your application" + amtPart + " has been officially submitted for review.";
            ...
            case "DOCS_REUPLOADED" ->
                "Success: Your documents have been re-uploaded and are now in the verification queue.";
            ...
            case "PARTIAL" ->
                "Protocol Update: Your application is partially complete. Please finish the remaining steps.";
